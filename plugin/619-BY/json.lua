...
function parse(str, idx)
  local chr
  idx = next_char(str, idx or 1, space_chars, true)
  chr = str:sub(idx, idx)
  if chr == '"' then
...
local function escape_char(c)
  return escape_char_map_inv[c] or string.format("\\u%04x", c:byte())
end
