...
type DeviceReq struct {
	Name      string            `json:"name" binding:"required" form:"name"`       // 设备名称
	Type      *DeviceTypeReq    `json:"type" binding:"required" form:"type"`       // 设备类型
	Address   string            `json:"address" binding:"required" form:"address"` // 通讯地址
	Collector *CollectorSaveReq `json:"collector" form:"collector"`
	...
	//----------------------------------------------------------------------------
	InitialVal float64 `json:"initialVal" form:"initialVal"`
